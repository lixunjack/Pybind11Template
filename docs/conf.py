# Jack Li
# codawavesolver documentation build configuration file
...
# Generate autodoc summaries automatically
...
# Paths for static files (e.g., CSS, JavaScript, images).
...
#
## Example configuration for intersphinx: refer to the Python standard library.
#intersphinx_mapping = {"https://github.com/lixunjack/CodaWaveSolver": None}
